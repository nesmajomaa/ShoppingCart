...
<body>
    ...
    <form method="post" enctype="multipart/form-data" action="{{ URL::to('/user/register') }}">
                ...
                <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                        <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            @else
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="floatingInput" name="email" value="{{ $email }}">
                                <label for="floatingInput">Email address</label>
                            </div>
                            @endif
                            <div class="form-floating mb-3">
                                <input type="phone" class="form-control" id="floatingInput" name="phone" placeholder="0123456789">
                            ...
                            <div>
                                <input class="form-control form-control-lg mb-3" name="img" placeholder="User Image" id="formFileLg" type="file">
                            </div>
