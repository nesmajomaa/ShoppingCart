...
<body class="homepage">
  ...
  <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasFavorite" aria-labelledby="My Favorite">
    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <span class="badge bg-primary rounded-pill">{{ $favorites->count() }}</span>
        </h4>
        <ul class="list-group mb-3">
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">{{ $favorite->favoriteProduct['name'] }}</h6>
              <small class="text-body-secondary">{{ $favorite->favoriteProduct['description'] }}</small>
            </div>
            {{-- <span class="text-body-secondary">${{ $favorite->favoriteProduct['price'] }}</span> --}}
            <span class="text-body-secondary">
                <a href="{{ URL::to('/removeFromFavorite/' . $favorite->favoriteProduct->id) }}" class="btn-icon btn-wishlist">
 ...
 <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
  ...
  <div class="offcanvas-body">
    <div class="order-md-last">
        ...
        @foreach ($cartItems as $cartItem)
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div class="d-flex align-items-center">
              <a href="{{ URL('/removeItemFromCart/' . $cartItem->id)}}" > 
              <button type="button" class="btn-close" aria-label="Close" style="margin-right: 15px;"></button>
            </a>
              <div>
                <h6 class="my-0">{{ $cartItem->cartProduct->name }} (${{ $cartItem->cartProduct->price }})</h6>
                <small class="text-body-secondary">{{ $cartItem->cartProduct->description }}</small>
              </div>
            </div>
            <div class="d-flex align-items-center">
              <div class="input-group mb-3" style="width: 100px;">
                <button class="form-control text-center" type="button"><a href="{{ URL::to('/decreaseItem/'. $cartItem->cartProduct->id) }}">-</a></button>
                  <span class="text-body-secondary">
                    <input hidden name="itemId" value="{{ $cartItem->id }}">
                    <label class="form-control text-center">{{ $cartItem->quantity}}</label>
                  </span>
                    <button class="form-control text-center" type="button"><a href="{{ URL::to('/increaseItem/'. $cartItem->cartProduct->id) }}">+</a></button>
              </div>
            </div>
          </li>
        @endforeach
      ...
      <a href="{{ URL('/checkout/' . $totalPrice)}}" > 
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">{{ Auth::guard('user')->user()->name }} </a>
                    </li>
                    <li>
                      <a href="{{URL::to('/user/logout')}}" class="dropdown-item item-anchor">Logout </a>
                    </li>
                  </ul>
                </li>
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            <li class="d-none d-lg-block">
              {{-- <a href="" class="text-uppercase mx-3">Wishlist <span class="wishlist-count">({{ $favorites->count() }})</span>
              </a> --}}

              <a href="" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFavorite"
                aria-controls="offcanvasFavorite">Wishlist <span class="wishlist-count">({{ $favorites->count() }})</span>
              </a>

            </li>
            <li class="d-none d-lg-block">
              <a href="" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                aria-controls="offcanvasCart">Cart <span class="cart-count">({{ $cartItems->count() }})</span>
              </a>
            </li>
            <li class="d-lg-none">
              <a href="#" class="mx-2">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="{{ asset($category->img) }}" alt="category" class="img-fluid">
                  </a>
                </div>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="#">
                  <img src="{{ asset($product->img) }}" alt="product" class="product-image img-fluid">
                </a>
                <a href="{{ URL::to('/addToFavorite/'.$product->id) }}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                  </svg>
                </a>
                <div class="product-content">
                  ...
                  <a href="{{ URL::to('/addToCart/'.$product->id) }}" class="text-decoration-none" data-after="Add to cart"><span>${{ $product->price}}</span></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="{{ asset($lastCategory->img) }}" alt="collection" class="product-image img-fluid">
            </div>
          </div>
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-5 m-0 m-md-5">
              <h3 class="element-title text-uppercase">{{ $lastCategory->name }}</h3>
        ...
        <div class="swiper-wrapper d-flex">
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="#">
                  <img src="{{ asset($product->img) }}" alt="categories" class="product-image img-fluid">
                </a>
                <a href="{{ URL::to('/addToFavorite/'.$product->id) }}" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            ...
            <p>Do you have any questions or suggestions? <a href="#"
                class="item-anchor">contact@kaira.com</a></p>
            <p>Do you need support? Give us a call. <a href="#" class="item-anchor">+43 720 11 52
                78</a>
            </p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2024 Kaira. All rights reserved. Design by 
              <a href="#" target="_blank">Kaira Store</a> 
              Distribution By <a href="#"target="blank">Kaira Team</a>
            </p>
          </div>
        </div>
      </div>
